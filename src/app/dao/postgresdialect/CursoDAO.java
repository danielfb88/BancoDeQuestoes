...
public class CursoDAO implements ICursoDAO {
	...
	public int adicionar(Curso curso) {
		...
		try {
			...
			preparedStatement.setString(1, curso.getDescricao());
			preparedStatement.setString(2, curso.getSigla());
			preparedStatement.setString(3, curso.getTipo_graduacao());
	...
	public List<Curso> getAllBy(Curso curso) {
		...
		// Tipo_Graduacao
		if (curso.getTipo_graduacao() != null) {
		...
		try {
			...
			if (ordemDoId_curso > 0)
				preparedStatement.setInt(ordemDoId_curso, curso.getId_curso());
			...
			if (ordemDaSigla > 0)
				preparedStatement.setString(ordemDaSigla, curso.getSigla());

			if (ordemDoTipo_graduacao > 0)
				preparedStatement.setString(ordemDoTipo_graduacao,
						curso.getTipo_graduacao());
